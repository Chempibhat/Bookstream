...
def main():
    ...
    app_mode = st.sidebar.radio("Choose the Page accordingly", ["Homepage", "Top 50 Books", "Similar Interest Books"])
...
def page1():
    ...
    st.write('<p style="font-family: Arial; font-weight: bold; font-size: 35;">Here are our top 50 books recommendetion</p>', unsafe_allow_html=True)
...
def page2():
    ...
    if book_name != 'None':
        try:
            ...
            st.stop()
        st.write('<p style="font-family: Arial; font-weight: bold;">Here are our Top 10 recommendations based on your book selection</p>', unsafe_allow_html=True)
